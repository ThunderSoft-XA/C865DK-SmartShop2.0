...
public class MainActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initResourceFile() {
        ...
        moveAssetToPath("age-gender-05.dlc", SAVE_PATH);
    ...
    class AIStartThread extends Thread {
        ...
        public void run() {
            ...
            if (GlobalConfig.ENABLE_AGEGENDER_DETECT) {
                AgeGenderDectorTask.getAgeGenderDectorTask().init(getApplication(),
                        idList,
                        fragmentManageList,
                        GlobalConfig.AGEGENDER_WIDTH,
                        GlobalConfig.AGEGENDER__HEIGHT);
            }
            isAllowClick++;
        }
    }
...
//                    startActivity(new Intent(MainActivity.this, SettingActivity.class));
    ...
    private void stopAIService() {
        if (GlobalConfig.ENABLE_AGEGENDER_DETECT) {
            AgeGenderDectorTask.getAgeGenderDectorTask().closeService();
        }
    ...
    private PlayFragment createPlayFragment(int index) {
        if (DeviceCollection.getAlgorithmType(index, Constants.ENABLE_AGEGENDER_STR)) {
            return new AgeGenderDetectFragment(index);
        }
